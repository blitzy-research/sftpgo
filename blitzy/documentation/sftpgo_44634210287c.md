...
sequenceDiagram
    ...
    GetUser-->>SqlCommon: sql.ErrNoRows
...
| `config/config.go` | Default config struct `init()` (lines 41-94), `LoadConfig()` (lines 145-182), `getRedactedGlobalConf()` (lines 134-138), banner construction (line 32) |
